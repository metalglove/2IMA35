...
def main():
    ...
    timings = experiment2(sc)
    save_experiment('experiment2.csv', timings)

    timings = experiment3(sc)
    save_experiment('experiment3.csv', timings)

    timings = experiment4(sc)
    save_experiment('experiment4.csv', timings)
